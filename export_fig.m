        ...
        if isbitmap(options)
            ...
            if options.transparent && (options.png || options.alpha)
                ...
                if options.png
                    ...
                    % Save the png
                    imwrite(A, [options.name '.png'], 'Alpha', ...
                            double(alpha), 'ResolutionUnit', 'meter', ...
            ...
            if options.png
                res = options.magnify * get(0, 'ScreenPixelsPerInch') / 25.4e-3;
                imwrite(A, [options.name '.png'], 'ResolutionUnit', ...
                        'meter', 'XResolution', res, 'YResolution', ...
                        res, 'Software', hash);
            end
            if options.bmp
            ...
            if options.jpg
                ...
                if quality > 100
                    imwrite(A, [options.name '.jpg'], 'Mode', ...
                            'lossless', 'Comment', hash);
                else
                    imwrite(A, [options.name '.jpg'], 'Quality', ...
                            quality, 'Comment', hash);
                end
            end
